...
import { usePublicTransparencia } from '../../transparencia/hooks/usePublicTransparencia'
import { TRANSPARENCY_SECTION_ID } from '../config/landingAnchors'
import type { TransparencySectionProps } from '../props/TransparencySectionProps'
