...
import { CATEGORIAS_PATH, ENTRADAS_PATH, MATERIAL_NEW_PATH, PROVEEDORES_PATH, SALIDAS_PATH, SOLICITUDES_REVISION_PATH, materialEditPath } from './inventarioPaths'
